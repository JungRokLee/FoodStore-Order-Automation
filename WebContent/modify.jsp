			...
			<article class="container box style3">
				<section>
					...
					<form action="modifyOk.jsp" method="post" name="reg_frm">
						...
						<div class="row">
							<div class="12u">
								<input class="text" type="text" name="name" value="" placeholder="관리자 이름" />
							</div>
								<div class="12u">
								<input class="text" type="text" name="address" value="" placeholder="관리자 주소" />
							</div>
						</div>
						<div class="row">
							<div class="12u">
								<textarea name="inform"  placeholder="관리자소개를 입력하세요"></textarea>
							</div>
						</div>
						<div class="row">
							<div class="12u">
