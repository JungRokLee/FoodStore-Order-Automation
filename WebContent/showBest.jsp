...
ArrayList<OrderDto> dtos = dao.SearchOrderTop(id);
...
<body>
	...
	<form action="listOfMenu.jsp?id=<%=id%>" method="post" name="doOrder">
		...
		<div class="wrapper">
			...
			</h3>	<font color='white'>총 판매액 : <%=totalprice %>원!!!</font> 					    <a href="showMostPrice.jsp"><font color='white' size=2>가장 수익이 많은 음식(클릭)</font></a>
