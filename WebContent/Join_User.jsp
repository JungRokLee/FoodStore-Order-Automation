	...
	<body> 
			<article class="container box style3">
				<section>
					...
					<form action="JoinOkUser.jsp" method="post">
						<div class="row">
							<div class="6u">
						...
						<div class="row">
							<div class="12u">
								<textarea name="inform"  placeholder="본인 소개를 입력하세요"></textarea>
							</div>
						</div>
						<div class="row">
							<div class="12u">
		...
		<section id="footer">
			...
			<div class="copyright">
				<ul class="menu">
					<li>&copy; Untitled. All rights reserved.</li>					<li>&copy; Untitled. All rights reserved.</li><li>게발자 : 이정록</li>
				</ul>
			</div>
		</section>
